...
class AccountProfile extends Component {
    ...
    updateProfile = (e) => {
        const {
            _id, firstName, lastName, password, phoneNumber,
            confirmPassword, jwtSecret, jwtQuestion
        } = this.state;
        e.preventDefault()
        const url = "update"
        let body = {
            _id, url, firstName, lastName, password,
            phoneNumber, confirmPassword, jwtSecret, jwtQuestion
        }
    ...
    render() {
        const {
            ...
            wishlist, user, jwtSecret, jwtQuestion
        } = this.state
