          ...
          >
            ...
            <tr>
              ...
              <td className="text-center px-4 pb-4">
                <a className="btn btn-sm btn-block text-danger mb-2" href="/">
              ...
              <td className="text-center px-4 pb-4">
                ...
                <h3 className="product-title font-size-sm">
                  <a className="comparison-item-title"
                     href="/">
                    Samsung Galaxy S10+
                  </a>
                </h3>
            ...
            <tr>
              ...
              <td>
                Yes Water resistant (up to 30 minutes in a depth of 1.5 meter),
                IP68
              </td>
            </tr>
            <tr>
